...
export default function App() {
  const [city, setCity] = useState("Fraine")
...
function getWeather(city) {
  return fetch(
    `https://api.openweathermap.org/data/2.5/weather/?q=${city}&units=metric&APPID=691b9cea233bc942f45caf3b39c7f0ff
`
  )
...
function getForecast(city) {
  return fetch(
    `https://api.openweathermap.org/data/2.5/forecast/?q=${city}&units=metric&APPID=691b9cea233bc942f45caf3b39c7f0ff
`
  )
    .then(res => handleResponse(res))
    .then(forecastData => {
